  ...
  return (
    <div className="view-container">
      <div className="panel-container">
        ...
        >
          <div className="p-4">
            ...
            <div className="mt-6 space-y-2">
              <button
                type="button"
                className="w-full rounded bg-primary px-3 py-2 text-primary-foreground text-sm transition-opacity hover:opacity-90"
              >
                Add Hook
              </button>
              <button
                type="button"
                className="w-full rounded border border-border px-3 py-2 text-foreground text-sm transition-colors hover:bg-accent hover:text-accent-foreground"
              >
                Install Hooks
              </button>
            </div>
          ...
          <div className="border-border border-b bg-muted/50 p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="rounded border border-border px-3 py-1 text-muted-foreground text-sm transition-colors hover:bg-accent hover:text-foreground"
                >
                  Edit
                </button>
              </div>
                  ...
                  <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="font-mono text-muted-foreground text-xs">
                        ✓ Linting passed
                        <br />✓ Formatting passed
                        <br />✓ Type checking passed
                      </div>
                    </div>
                  </div>
        ...
        <div
          className="panel"
          style={{ width: '300px', borderLeft: '1px solid var(--color-border)' }}
        >
          <div className="p-4">
            ...
            <div className="space-y-2">
              <Button
                variant="ghost"
                className="h-auto w-full justify-start p-2 text-muted-foreground text-sm"
              >
                Git Hooks Guide
              </Button>
              <Button
            ...
            <div className="mt-6">
              <div className="rounded-lg border border-border bg-muted p-3">
                ...
                <div className="text-muted-foreground text-xs">5 active hooks • 2 disabled</div>
