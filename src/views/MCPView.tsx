          ...
          <div className="p-4">
            ...
            <div className="space-y-2">
              <div className='flex cursor-pointer items-center justify-between rounded p-2 transition-colors hover:bg-accent hover:text-accent-foreground'>
                ...
                <Button variant="link" size="sm" className="h-auto p-0 text-xs">Connect</Button>
              </div>
              <div className='flex cursor-pointer items-center justify-between rounded p-2 transition-colors hover:bg-accent hover:text-accent-foreground'>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className='rounded-lg border border-border bg-card p-3'>
                      ...
                      <div className='font-mono text-muted-foreground text-xs'>/Users/user/project</div>
                    </div>
                    <div className='rounded-lg border border-border bg-card p-3'>
                  ...
                  <div className="space-y-3">
                    <div className='rounded-lg border border-border bg-card p-3'>
                      <div className='mb-1 font-medium text-foreground text-sm'>Allowed Extensions</div>
            ...
            <div className="mt-4">
              <div className='rounded-lg border border-border bg-card p-3'>
                ...
                <div className="space-y-1">
                  <Button variant="link" className='h-auto justify-start p-0 text-muted-foreground text-xs'>
                    MCP Protocol Spec
                  </Button>
                  <Button variant="link" className='h-auto justify-start p-0 text-muted-foreground text-xs'>
                    Server Development
