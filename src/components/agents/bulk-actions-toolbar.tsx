import { Trash2, ArrowUpDown, UserCheck, X } from 'lucide-react';
...
import { clearSubAgentSelection, $selectedSubAgentIds, removeSubAgent } from '@/stores/agents.store';
    ...
    <div className="flex items-center justify-between p-2 mb-2 bg-muted/50 rounded-lg border">
      ...
      <div className="flex items-center gap-1">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem onClick={() => handleAssignRole('reader')}>
              Reader
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleAssignRole('reviewer')}>
              Reviewer
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleAssignRole('tester')}>
              Tester
            </DropdownMenuItem>
        ...
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={clearSubAgentSelection}
        >
          <X className="h-4 w-4" />
        </Button>
      </div>
