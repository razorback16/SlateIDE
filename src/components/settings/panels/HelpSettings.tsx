            ...
            <div className="space-y-4">
              <div className='flex items-center justify-between rounded-lg border border-border p-4'>
                <div className="flex flex-col gap-1">
                  ...
                  <p className='text-muted-foreground text-xs'>View the complete user guide and API documentation.</p>
                </div>
              ...
              <div className='flex items-center justify-between rounded-lg border border-border p-4'>
                <div className="flex flex-col gap-1">
                  ...
                  <p className='text-muted-foreground text-xs'>Report bugs or suggest new features.</p>
                </div>
              ...
              <div className='flex items-center justify-between rounded-lg border border-border p-4'>
                <div className="flex flex-col gap-1">
                  ...
                  <p className='text-muted-foreground text-xs'>Open the folder where app data is stored.</p>
                </div>
